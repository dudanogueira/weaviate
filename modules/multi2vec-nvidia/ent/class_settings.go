...
const (
	...
	DefaultNvidiaModel           = "nvidia/nvclip"
...
func NewClassSettings(cfg moduletools.ClassConfig) *classSettings {
	return &classSettings{
		cfg:  cfg,
		base: basesettings.NewBaseClassSettingsWithAltNames(cfg, LowerCaseInput, "multi2vec-nvidia", nil, nil),
	}
}

// Nvidia settings
func (cs *classSettings) Model() string {
	return cs.base.GetPropertyAsString(modelProperty, DefaultNvidiaModel)
}
