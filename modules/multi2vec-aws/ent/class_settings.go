...
func NewClassSettings(cfg moduletools.ClassConfig) *classSettings {
	return &classSettings{
		cfg:  cfg,
		base: basesettings.NewBaseClassSettingsWithAltNames(cfg, LowerCaseInput, "multi2vec-aws", nil, nil),
	}
}
...
func (ic *classSettings) validateFields(name string, fields any) (int, error) {
	fieldsArray, ok := fields.([]any)
	if !ok {
...
func (ic *classSettings) getWeights(name string) ([]any, bool) {
...
func (ic *classSettings) getWeightsArray(weights []any) ([]float32, error) {
...
func (ic *classSettings) getNumber(in any) (float32, error) {
